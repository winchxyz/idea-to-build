...
### Changed
- **README banner re-rendered to the build-first arc** (`idea → brainstorm → build → recheck`, build as the hero node) to match the re-cut demo video and the v0.5 positioning. `assets/logo.png`.
